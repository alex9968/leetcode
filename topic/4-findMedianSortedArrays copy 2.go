...
func main() {
	...
	fmt.Println(findMedianSortedArrays([]int{}, []int{}))                  // OJ 无此类异常 case
	fmt.Println(findMedianSortedArrays([]int{1, 3, 5}, []int{2, 4, 6}))    // 3.5
	fmt.Println(findMedianSortedArrays([]int{1, 3, 5, 7}, []int{2, 4, 6})) // 4
